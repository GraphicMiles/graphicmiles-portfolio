(function () {
    ...
    function mountDock() {
        ...
        const homeHref = page === "home" ? "#home" : root + "index.html#home";
        const projectsHref = page === "home" ? "#projects" : root + "index.html#projects";
        ...
        const items = [
            ...
            { key: "Resume", href: root + "Raji_Adewunmi_Farouq_Resume.pdf", label: "Resume", divider: true, external: true }
        ];
        ...
        items.forEach((item) => {
            ...
            a.addEventListener("click", (e) => {
                ...
                if (hashPos === -1) return;
                const hash = href.slice(hashPos + 1);
                const onHome = (document.body.dataset.page || "home") === "home";
                if (!onHome) return;
                e.preventDefault();
